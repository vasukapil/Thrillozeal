    ...
    value: function render() {
      ...
      if (activeIndex > numDotsToShow - 2 && adjustedDots.length > numDotsToShow || this.hasAnimated) {
        ...
        if (lastViewableDotIndex < adjustedDots.length - 1 && isMovingForward) {
          ...
          adjustedDots = [].concat(toConsumableArray(adjustedDots.slice(0, firstViewableDotIndex)), [React__default.cloneElement(firstViewableDot, {
            className: prevNextDotClassName
          })], toConsumableArray(adjustedDots.slice(firstViewableDotIndex + 1, lastViewableDotIndex)), [React__default.cloneElement(lastViewableDot, {
            className: prevNextDotClassName
          ...
          adjustedDots = [].concat(toConsumableArray(adjustedDots.slice(0, firstViewableDotIndex)), [React__default.cloneElement(firstViewableDot, {
            className: prevNextDotClassName
          })], toConsumableArray(adjustedDots.slice(firstViewableDotIndex + 1, lastViewableDotIndex)), [this.addActiveClassToLastDot || activeIndex === lastViewableDotIndex ? React__default.cloneElement(lastViewableDot, {
          ...
          adjustedDots = [].concat(toConsumableArray(adjustedDots.slice(0, lastViewableDotIndex)), [React__default.cloneElement(lastViewableDot, {
            className: prevNextDotClassName
          })], toConsumableArray(adjustedDots.slice(lastViewableDotIndex + 1)));
        }
      }
      // no leftOffset in place, just render the dots
          ...
          if (_lastViewableDotIndex < adjustedDots.length - 1) {
            ...
            adjustedDots = [].concat(toConsumableArray(adjustedDots.slice(0, _lastViewableDotIndex)), [React__default.cloneElement(_lastViewableDot, {
              className: prevNextDotClassName
...
module.exports = MagicSliderDots;
